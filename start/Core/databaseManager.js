...
async getFont(botNumber, defaultValue = 'normal') {
    return await this.get(botNumber, 'bot_font', defaultValue);
}

async setFont(botNumber, fontStyle) {
    return await this.set(botNumber, 'bot_font', fontStyle);
}
